...
<body>
    ...
    <?php
        ...
        $api_key = 'BB1942B65ECC5A5AB33F1F3BEABC2BBF';
        ...
        $data_GetSchema = file_get_contents('http://api.steampowered.com/ITFItems_440/GetSchema/v0001/?key=' . $api_key . '&format=json' . '&language=' . $language);
        ...
        $data_GetPlayerSummaries = file_get_contents('http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0001/?key=' . $api_key . '&steamids=' . $steamId64);
        ...
        $data_GetPlayerItems = file_get_contents('http://api.steampowered.com/ITFItems_440/GetPlayerItems/v0001/?key=' . $api_key . '&SteamID=' . $steamId64);
